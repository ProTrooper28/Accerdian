...
const pillars = [
  { t: "Curated by practitioners", d: "Every program is designed with senior operators from Fortune 500 companies — not by generalists." },
  { t: "Adaptive to your context", d: "We map programs to your team's skill gaps, career stage, and business outcomes." },
  { t: "Outcome‑led delivery", d: "Every cohort is measured against pre‑defined KPIs, not attendance or completion rate." },
  { t: "White‑glove partnership", d: "A dedicated learning partner accompanies your team from kickoff to retrospective." },
];

export function Edge() {
  return (
    <section id="edge" className="relative py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-12">
          <div className="md:col-span-5">
            <SectionHeading
              eyebrow="The Accredian Edge"
              title={<>Key aspects of our <span className="text-muted-foreground">strategic training.</span></>}
